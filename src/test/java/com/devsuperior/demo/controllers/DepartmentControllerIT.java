...
public class DepartmentControllerIT {
	...
	// findAll deve retornar todos os recursos classificados por nome quando o administrador estiver conectado
	@Test
	...
	public void findAllShouldReturnAllResourcesSortedByNameWhenEmployeeLogged() throws Exception {
		...
		ResultActions result =
				mockMvc.perform(get("/departments")
					.header("Authorization", "Bearer " + accessToken) // o token do usuario
					.contentType(MediaType.APPLICATION_JSON));
